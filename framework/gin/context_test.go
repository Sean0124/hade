...
import (
	...
	testdata "github.com/Sean0124/hade/framework/gin/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/Sean0124/hade/framework/gin.handlerNameTest$", c.HandlerName())
}
